...
<body>
    <div class="container">
        <form action="index.php?action=create" method="POST" onsubmit="return validateForm()">
            <h1>Inscription</h1>
            <img src="../../../public/images/iconeInscription.jpg" alt="Icone " class="img-top-right">
            ...
            <div id="eleveFields" style="display:none;">
                <div class="form-row d-flex flex-wrap">
                    ...
                    <div class="col-sm-4 form-group">
                        ...
                        <input type="text" name="classe" class="form-control" placeholder="Entrer votre classe">
                        <div class="error-message" id="errorClasseEleve"></div>
                    </div>

                    <div class="col-sm-4 form-group">
                        <label for="numerotuteur">Nom Tuteur :</label>
                        <input type="text" name="numerotuteur" class="form-control" placeholder="Entrer le nom de tuteur">
