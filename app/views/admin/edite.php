...
<body>
    <div class="container">
        <form id="adminForm" action="/public/index.php?action=update&role=<?= $role ?>&id=<?= $users["id"]?>" method="POST">
            ...
            <div class="text-center">
                ...
                <button class="btn btn-primary" style="width: 200px;">
                    <a class="btn-primary" href="/public/index.php?action=liste&role=<?= $role?>">Retour</a>
                </button>
            </div>
        </form>
    </div>
